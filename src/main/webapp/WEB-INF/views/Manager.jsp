         ...
         <div class="row content">
            <div class="col-sm-2 sidenav">
               ...
               <ul class="nav nav-pills nav-stacked">
                  	 <li class="li active"><a id="changeContent" href="#" onclick="changeContent('allPrize')">獎品資料管理</a></li>                     
                  	 <li class="li"><a  href="#" onclick="changeContent('changePassword')">變更密碼</a></li>
